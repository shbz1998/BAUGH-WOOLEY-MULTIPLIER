...
HD_PWD='C:/Users/malik/Documents/FPGA_PROJECTS/BW_HARDWARE_VERIFICATION/BW_HARDWARE_VERIFICATION.runs/design_1_BW_MULTIPLIER_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BW_MULTIPLIER_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BW_MULTIPLIER_IP_0_0.tcl
